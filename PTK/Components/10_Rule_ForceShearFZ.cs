...
{
    public class _10_Rule_ForceShearFZ : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the _10_Rule_ForceShearFZ class.
        /// </summary>
        public _10_Rule_ForceShearFZ()
          : base("ElementForceShear FZ", "FZ",
              "Detail search based on Shear force (FZ) in the element's detail",
        ...
        {
            pManager.AddNumberParameter("Min Shear(FZ)", "<", "Minimum Shear(FZ) force in element", GH_ParamAccess.item, 0);
            pManager.AddNumberParameter("Max Shear(FZ)", ">", "Maximum Shear(FZ) force in element", GH_ParamAccess.item, 10000000);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //CHANGE
            Rules.ForceMode Mode = Rules.ForceMode.ShearDir2;
            //CHANGE
        ...
        {
            get { return new Guid("5be5688b-e4ea-410a-82a4-75531b9578f5"); }
        }
    }
}